const GroupCard = ({ title, image, description, startDate, onJoin }) => {
    return (
        <div className="flex flex-1 flex-col gap-4 p-6 lg:!p-10 lg:!gap-8
                      shadow-[8px_10px_20px_rgba(0,0,0,0.05)] bg-white rounded-xl">

            <h3 className="font-bold px-5 lg:!px-0 text-center 
            ...
            <div className="flex  flex-col items-start lg:flex-row lg:!gap-10">
                ...
                <img src={image} alt={title} className="w-full lg:w-[50%] xl:w-[40%] h-auto object-contain" />
